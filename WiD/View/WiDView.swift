                ...
                ZStack {
                    ...
                    Button(action: {
                        ...
                        Text("완료")
                            ...
                            .padding(.vertical, 4)
                            .background(isStartOverlap || isStartOverCurrentTime || isFinishOverlap || isFinishOverCurrentTime || !DurationExist ? .gray : .green)
                        ...
                        VStack(spacing: 8) {
                            ...
                            .background(
                                RoundedRectangle(cornerRadius: 8)
                                    ...
                                    .background(isDeleteButtonPressed ? .red : .white)
                            )
                            .cornerRadius(8)
                            .padding(.horizontal)
                        }
