...
//struct SmallPieGraphView: UIViewRepresentable {
...
//                colors.append(NSUIColor(named: "LightGray-Black")!)
//            }
//            
//            // WiD 객체의 시간대 엔트리 추가
...
//struct LargePieGraphView: UIViewRepresentable {
//    private let wiDList: [WiD]
//    private let entryList: [PieChartDataEntry]
//    private let colorList: [NSUIColor]
//    private let calendar = Calendar.current
